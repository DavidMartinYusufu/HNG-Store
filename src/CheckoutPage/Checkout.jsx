...
function Checkout() {
  return (
    <div>
      <Check1 />
      <div className=" flex flex-col ml-[16px] mr-[16px] md:flex-row gap-[32px] mt-[80px] mb-[80px] md:mr-[112px] md:ml-[112px]">
        <div className="flex flex-col w-full bg-palewhite rounded-[16px]  pt-[32px] pb-[32px] pr-[16px] pl-[16px]">
